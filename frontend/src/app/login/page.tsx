...
export default function LoginPage() {
  ...
  const { user, loading, error, login, loginWithGoogle, clearError, initAuth, initialized } = useAuthStore();
    ...
    <div className={styles.authPage}>
      ...
      <div className={styles.authContainer}>
        ...
        <div className={`glass-card ${styles.authCard}`}>
          ...
          <p className={styles.authSubtitle}>Sign in to continue journaling</p>
