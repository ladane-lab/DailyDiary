...
export default function DashboardError({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] text-center px-4 space-y-4">
      ...
      <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-200">Failed to load dashboard</h2>
      <p className="text-gray-600 dark:text-gray-400 max-w-md">
        We couldn't load your statistics and activity. This might be a temporary issue.
      </p>
      <button
        onClick={() => reset()}
